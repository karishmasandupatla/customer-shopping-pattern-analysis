...
--Q1. What is the total revenue generated bt male vs. female customers?
...
-- select item_purchased,sum(purchase_amount)as Hihest_per 
-- from customer where discount_applied='Yes' 
-- group by item_purchased order by Hihest_per desc limit 5 ;
